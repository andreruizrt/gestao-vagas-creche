...
const TermosDeUso = () => (
    <>
        ...
        <VStack m={100}>
            ...
            <Heading size={'md'}>1. DA FUNÇÃO DO SITE</Heading>
            <Text>
            ...
            <Heading size={'md'}>2. DO ACEITE DOS TERMOS</Heading>
            <Text>
                Este documento, chamado “Termos de Uso”, aplicáveis a todos os visitantes do site, foi desenvolvido pelo Advogado Diego Castro (OAB/PI 15.613), modificado com permissão para este site.
            ...
            <Heading size={'md'}>3. DO GLOSSÁRIO</Heading>
            <Text>
            ...
            <Heading size={'md'}>4. DO ACESSO AO SITE</Heading>
            <Text>
            ...
            <Heading size={'sm'}>5. DA LICENÇA DE USO E CÓPIA</Heading>
            <Text>
            ...
            <Heading size={'sm'}>6. DAS OBRIGAÇÕES</Heading>
            <Text>
            ...
            <Heading size={'sm'}>7. DA MONETIZAÇÃO E PUBLICIDADE</Heading>
            <Text>
            ...
            <Heading size={'sm'}>8. DOS TERMOS GERAIS</Heading>
            <Text>
